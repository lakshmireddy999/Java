...
as it gets initialised immediately next to class name.
The primary constructor initializes the class,

 Secondary: ne or more secondary constructors which is defined
...
class P33Constructors constructor(num1:Int,num2:Int) //primary constructor with two parameters
{
